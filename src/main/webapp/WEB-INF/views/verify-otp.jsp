...
<head>
    ...
    <title>OTP Doğrulama | <spring:message code="app.name" /></title>
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-group input { height: 42px; border: 1px solid #d1d5db; border-radius: 8px; padding: 0 14px; font-size: 16px; letter-spacing: 2px; text-align: center; font-family: inherit; color: #1a1a2e; outline: none; transition: border-color 0.15s, box-shadow 0.15s; }
...
<main>
    <div class="login-card">
        ...
        <form action="/forgotten-password-verify" method="post">
            <input type="hidden" name="email" value="${email}">

            <div class="form-group">
                <label for="otp">Doğrulama Kodu</label>
                <input type="text" id="otp" name="otp" placeholder="------" maxlength="6" required autofocus>
            </div>

            <button type="submit" class="btn-login">Doğrula</button>
        </form>
